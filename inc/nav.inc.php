<?php switch ($pg) {
	...
	case 'contact':
	case 'terms': ?>
<nav class="navbar navbar-transpaNegotiable navbar-color-on-scroll fixed-top navbar-expand-lg navbar-transparent"
     color-on-scroll="100"
     id="sectionsNav">
    <div class="container">
...
<?php	break;
    ...
    case 'space':
    case 'q': ?>
<nav class="navbar navbar-transpaNegotiable fixed-top navbar-expand-lg" color-on-scroll="100"
     id="sectionsNav">
    <div class="container">
        <div class="navbar-translate">
            <a class="navbar-brand" href="<?php echo $dir ?>">
